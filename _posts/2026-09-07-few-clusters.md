...
3.  **Using $t(G-1)$ critical values is free and helps.** If your software does this by default (Stata and `fixest` do), you are already better off than the 2021 thread was.
