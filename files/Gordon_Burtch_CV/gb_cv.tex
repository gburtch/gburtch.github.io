...
\item \textbf{\underline{Burtch, G.}, Lee, D., \& Chen, Z.} (2024) ``The Consequences of Generative AI for Online Knowledge Communities''. Forthcoming at \textit{Scientific Reports}
...
\item \textbf{Urrea, G., Villa, S, Yoo, E., \& \underline{Burtch, G.}} ``Cognitive Biases in Cryptocurrency Donations: The Influence of Market Changes and Urgency'' Under 1st Round Review at \textit{Production \& Operations Management (POM)} \\ -- POMS Humanitarian Operations and Crisis Management (HOCM) Best Paper Award
