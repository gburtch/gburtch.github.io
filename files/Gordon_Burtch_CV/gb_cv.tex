...
\item \textbf{Anderson, M., \underline{Burtch, G.}, \& Greenwood, B.} (2025) ``The Effect of Abortion Restrictions on Infant Mortality in the United States''. Forthcoming at \textit{American Journal of Public Health}
...
\item \textbf{Sanatizadeh, A., \underline{Burtch, G.}, Hong, Y., \& Hu, Y.} ``Online Review Suppression via Legal Threats: Prevalence, Consequences, and Policy Responses''. Minor Revision at \textit{Information Systems Research (ISR)}

\item \textbf{Liang, C., Tunc, M. \& \underline{Burtch, G.}} ``Market Punishment of Strategic Generosity: An Empirical Examination of NFT Charity Auctions''. Preparing for 3rd Round Review at \textit{Information Systems Research (ISR)}

\item \textbf{\underline{Burtch, G.}, McFowland E., Yang, M., \& Adomavicius, A.} ``Ensemble IV: Creating Instrumental Variables from Ensemble Learners for Robust Statistical Inference''. Preparing for 3rd Round Review at \textit{Management Science}
...
\item \textbf{Adbi, A., \underline{Burtch, G.} \& Dhanorkar, S.} ``Can Mandatory E-Waste Laws Crowd-Out Voluntary Environmental Initiatives? Evidence from a Quasi-Experiment''. Preparing for Submission to \textit{POM}

\item \textbf{Urrea, G., Villa, S, Yoo, E., \& \underline{Burtch, G.}} ``Cognitive Biases in Cryptocurrency Donations: The Influence of Market Changes and Urgency'' Preparing for Submission to \textit{Journal of Operations Management} \\ -- POMS Humanitarian Operations and Crisis Management (HOCM) Best Paper Award

\item \textbf{Lee, J., \underline{Burtch, G.}, \& Dellarocas, C.} ``Managing the Transition from Crowd Volunteerism to Paid Work: Evidence from the Field''. Preparing for Submission to \textit{Organization Science}

\item \textbf{\underline{Burtch, G.}, Moakler, R., Zhang, P., Hill, S., \& Gordon, B.} ``On the Validity of Meta's Advertiser Experimentation Tools''. Preparing for Submission to \textit{Marketing Science: Frontiers} 
...
\tllabelcventry[gray]{2022}{2024}{2022--}{IS PhD Program Liaison}{Questrom School of Business}{Boston University}{}{}
