...
\tllabelcventry[gray]{2021}{0}{2021--}{PRO Unlimited @ Meta -- Central Applied Science}{Consulting Researcher}{New York, NY}{}{}
...
\tldatecventry[gray]{2025}{INFORMS Management Science}{(Finalist) Award for Best Published Paper in Prior 3 Years}{}{}{}{}
...
\item \textbf{Sanatizadeh, A., \underline{Burtch, G.}, Hong, Y., \& Hu, Y.} (2025) ``Online Review Suppression via Legal Threats: Prevalence, Consequences, and Policy Responses''. Forthcoming in \textit{Information Systems Research (ISR)}

\item \textbf{Anderson, M., \underline{Burtch, G.}, \& Greenwood, B.} (2025) ``The Effect of Abortion Restrictions on Infant Mortality in the United States''. Forthcoming in \textit{American Journal of Public Health}

\item \textbf{Huang, N., \underline{Burtch, G.}, Huang, A. \& Chen, P.} (2025) `Evaluating the Efficacy of Application Costs for Managing Congestion in Online Matching Markets''. Forthcoming at \textit{Management Science} 

\item \textbf{Xu, L., Xie, Q., \& \underline{Burtch, G.}} (2025) ``An Empirical Study of Strategic Opacity in Crowdsourced Quality Evaluations''. Forthcoming at \textit{MIS Quarterly}

\item \textbf{Bapna, S. \& \underline{Burtch, G.}} (2025) ``An Experimental Evaluation of Gender Differences in Responses to Major-Donor Funding Schemes for Crowdfunded Social Ventures''. Forthcoming at \textit{Information Systems Research (ISR)}

\item \textbf{Schanke, S.,  \underline{Burtch, G.} \& Ray, G.} (2025) ``Digital Lyrebirds: Experimental Evidence That Voice-based DeepFakes Influence Trust''. Forthcoming at \textit{Management Science} 
...
\item \textbf{Dellarocas, C., Lee, J., Zalmanson, L. \& \underline{Burtch, G.}} (2025). ``Balancing Purpose and Profit: Managing Volunteer Contributions in Digital Platforms'', \textit{Harvard Business Review}.
...
\item \textbf{Zeng, H., Huang, Y., \underline{Burtch, G.}, \& Smith, M.} ``Operational Decision-making Around Movie Piracy \& Theatrical Release''. Minor Revision at \textit{Manufacturing \& Service Operations Management (MSOM)}

\item \textbf{\underline{Burtch, G.}, McFowland E., Yang, M., \& Adomavicius, A.} ``Ensemble IV: Creating Instrumental Variables from Ensemble Learners for Robust Statistical Inference''. Under 3rd Round Review at \textit{Management Science}

\item \textbf{Sabzehzar, A., \underline{Burtch, G.}, Hong, Y. \& Santanam, R.} ``The Efficacy of Need-based Attentional Interventions in Educational Crowdfunding''. Preparing for 3rd Round Review at \textit{Information Systems Research}
...
\section{Teaching}
\tllabelcventry[gray]{2025}{0}{2025--}{BA 510}{Applied Neural Networks: From Foundations to Generative AI}{Boston University}{(Undergraduate)}{}
...
\tldatecventry[gray]{2025}{Jiho Lee}{Co-Advisor (BU)}{National University of Singapore}{}{}
