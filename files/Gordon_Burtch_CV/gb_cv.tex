...
\item \textbf{Gao, Y., Lee, D., \underline{Burtch, G.} \& Fazelpour, S.} (2025) ``Take Caution in Using LLMs as Human Surrogates: Scylla Ex Machina'' Forthcoming at \textit{Proceedings of the National Academy of Sciences (PNAS)}

\item \textbf{Huang, N., \underline{Burtch, G.}, Huang, A. \& Chen, P.} (2025) `Evaluating the Efficacy of Platform-imposed Application Costs for Managing Congestion in Online Matching Markets''. Forthcoming at \textit{Management Science} 

\item \textbf{Zhang, S., Tong, S.,  Kwon, E., \underline{Burtch, G.} \& Li, X.} (2025) ``Recommending What to Search: How a Query Recommender System Affects Mobile Shopping''. Forthcoming at \textit{Marketing Science} 
...
\item \textbf{Tong, S., Zhang, Y.,  \underline{Burtch, G.} \& Lin, Z.} (2025) ``Individual Sellers' Social Media Participation and Sales Performance in Peer-to-Peer Marketplaces: Evidence from a Quasi-Natural Experiment''. Forthcoming at \textit{Production \& Operations Management (POM)} 
...
\item \textbf{\underline{Burtch, G.}, Greenwood, B. \& Ravindran, K.} (2025) ``Lucy and the Chocolate Factory: Warehouse Robotics and Worker Safety''. Forthcoming at \textit{Industrial Labor Relations Review (ILRR)} 
...
\item \textbf{Sanatizadeh, A., \underline{Burtch, G.}, Hong, Y., \& Hu, Y.} ``Online Review Suppression via Legal Threats: Prevalence, Consequences, and Policy Responses''. Preparing for 3rd Round Review at \textit{Information Systems Research (ISR)}
...
\item \textbf{\underline{Burtch, G.}, McFowland E., Yang, M., \& Adomavicius, A.} ``Ensemble IV: Creating Instrumental Variables from Ensemble Learners for Robust Statistical Inference''. Under 2nd Round Review at \textit{Management Science}

\item \textbf{Sabzehzar, A., \underline{Burtch, G.}, Hong, Y. \& Santanam, R.} ``The Efficacy of Need-based Attentional Interventions in Educational Crowdfunding''. Preparing for 2nd Round Review at \textit{Information Systems Research}
...
\item \textbf{Anderson, M., \underline{Burtch, G.}, \& Greenwood, B.} ``The Effect of Abortion Restrictions on Infant Mortality in the United States''. Preparing for 2nd Round Review at \textit{American Journal of Public Health}
...
\item \textbf{Lee, J., \underline{Burtch, G.}, \& Dellarocas, C.} ``Managing the Transition from Crowd Volunteerism to Paid Work: Evidence from the Field''. Preparing for Submission to \textit{Information Systems Research}

\item \textbf{\underline{Burtch, G.}, Greenwood, B., \& Watson, J.} ``The Effect of Gunshot Detection Technologies on Policing Practices: An Empirical Examination of the Chicago Police Department''. Preparing for Submission to \textit{Management Science}

\item \textbf{\underline{Burtch, G.}, Zhang, P., Moakler, R., \& Hill, S.} ``On the Validity of Meta's Advertiser Experimentation Tools''. Perparing for Submission to \textit{Marketing Science: Frontiers} 
