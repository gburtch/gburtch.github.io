...
\item \textbf{Tong, S., Zhang, Y.,  \underline{Burtch, G.} \& Lin, Z.} (2024) ``Individual Sellers' Social Media Participation and Sales Performance in Peer-to-Peer Marketplaces: Evidence from a Quasi-Natural Experiment''. Forthcoming at \textit{Production \& Operations Management (POM)} 

\item \textbf{Bapna, S. \& \underline{Burtch, G.}} (2024) ``An Experimental Evaluation of Gender Differences in Responses to Major-Donor Funding Schemes for Crowdfunded Social Ventures''. Forthcoming at \textit{Information Systems Research (ISR)}
...
\item \textbf{Lee, J., \underline{Burtch, G.}, \& Dellarocas, C.} ``Managing the Transition from Crowd Volunteerism to Paid Work: Evidence from the Field''. Under 2nd Round Review at \textit{MIS Quarterly}

\item \textbf{Zeng, H., Huang, Y., \underline{Burtch, G.}, \& Smith, M.} ``Operational Decision-making Around Movie Piracy \& Theatrical Release''. Under 2nd Round Review at \textit{Manufacturing \& Service Operations Management (MSOM)}
...
\item \textbf{Adbi, A., \underline{Burtch, G.} \& Dhanorkar, S.} ``Can Mandatory E-Waste Laws Crowd-Out Voluntary Environmental Initiatives? Evidence from a Quasi-Experiment''. Preparing for Submission to \textit{Nature: Sustainability}
