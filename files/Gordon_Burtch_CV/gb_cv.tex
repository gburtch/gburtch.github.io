...
\item \textbf{Watson, J., \underline{Burtch, G.}, \& Greenwood, B.} (2024) ``Do Digital Technologies Reduce Racially Biased Reporting? Evidence from NYPD Administrative Data''. Forthcoming at \textit{Proceedings of the National Academy of Sciences (PNAS)}

\item \textbf{Anderson, M., \& \underline{Burtch, G.}, \& Greenwood, B.} (2024) ``The Impact of Abortion Restrictions on American Mental Health'', Forthcoming at \textit{Science Advances}
...
\item \textbf{Adbi, A., \underline{Burtch, G.} \& Dhanorkar, S.} ``Can Mandatory E-Waste Laws Crowd-Out Voluntary Environmental Initiatives? Evidence from a Quasi-Experiment''. Under 1st Round Review at \textit{Strategy Science}
...
\section{Teaching}
\tllabelcventry[gray]{2021}{0}{2021--}{MSBA BA865}{Introduction to Neural Networks}{Boston University}{(Graduate)}{}
