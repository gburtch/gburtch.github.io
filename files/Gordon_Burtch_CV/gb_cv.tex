...
\item \textbf{Hassna, G., \& \underline{Burtch, G.}, Lee, C. H., \& Zhao, J. L.} (2023) ``Understanding the Role of Organizational Lead Donor Types in Civic Crowdfunding'', Forthcoming at \textit{Journal of the Association for Information Systems}
...
\item \textbf{Santanai, A., \underline{Burtch, G.}, Hong, Y., \& Hu, Y.} ``Online Review Censorship''. Preparing for 2nd Round Review at \textit{Information Systems Research}
...
\item \textbf{Sabzehzar, A., \underline{Burtch, G.}, Hong, Y. \& Santanam, R.} ``The Efficacy of Need-based Attentional Interventions in Educational Crowdfunding''. Target: \textit{Management Science}
