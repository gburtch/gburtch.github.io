...
\tllabelcventry[gray]{2021}{2022}{2021--2022}{Facebook Research -- Core Data Science}{Contractor}{New York, NY}{}{}
...
\tldatecventry[gray]{2022}{Core Data Science}{Facebook Research}{}{}{}{}
...
\item \textbf{Xu, L., \underline{Burtch, G.}, Xie, Q., \& Wang, L.} ``An Empirical Study of Strategic Opacity in Crowdsourced Quality Evaluations''. Preparing for 3rd Round Review at \textit{MIS Quarterly}

\item \textbf{Dhanorkar, S. \& \underline{Burtch, G.}} ``Can Mandatory E-Waste Laws Crowd-Out Voluntary Environmental Initiatives? Evidence from a Quasi-Experiment''. Under 2nd Round Review at \textit{Manufacturing \& Service Operations Management (MSOM)}

\item \textbf{Hou, J., Huang, N.., \underline{Burtch, G.}, Hong, Y. \& Chen, P.} ``Evaluating the Efficacy of Platform-imposed Application Costs for Managing Congestion in Online Matching Markets''. Under 2nd Round Review at \textit{Management Science} 
...
\item \textbf{\underline{Burtch, G.}, Greenwood, B. \& Ravindran, K.} ``Lucy and the Chocolate Factory: Warehouse Robotics and Worker Safety''. Under 1st Round Review at \textit{Management Science} 

\item \textbf{Zhang, H., Huang, Y., \underline{Burtch, G.}, \& Smith, M.} ``The When, Where, and Why of Movie Piracy: A Structural Model of Movie Piracy vs. Legal (in-Theater) Consumption''. Under 1st Round Review at \textit{Management Science}
...
\item \textbf{\underline{Burtch, G.}, Godinho de Matos, M., \& Lima, F.} ``Personal Social Networks, Technology Skills, and Worker Performance Under Telework''. Target: \textit{MIS Quarterly}

\item \textbf{\underline{Burtch, G.}, Yang, M., McFowland E. \& Adomavicius, A.} ``Ensemble IV: Creating Instrumental Variables from Ensemble Learners for Robust Statistical Inference''. Target: \textit{Annals of Applied Statistics}
...
\item \textbf{Deodhar, S. \& \underline{Burtch, G.}} ``Effect of Feedback Valence and Specificity in Online Design Contests: Randomized Field Experiment''. Target: \textit{Journal of the Association for Information Systems (JAIS)}
...
\item \textbf{\underline{Burtch, G.}, Lee, D. \& Chen, Z.} ``The Consequences of Generative AI for User-Generated Content and Online Community Engagement''. Target: \textit{Management Science}
...
\item \textbf{Liang, C., Tunc, M. \& \underline{Burtch, G.}} ``Market Punishment of Strategic Generosity: 
An Empirical Examination of NFT Charity Auctions''. Target: \textit{Management Science}

\item \textbf{Urrea, G., Villaneuva, S., Yoo, E., \& \underline{Burtch, G.}} ``The Influence of Cryptocurrency Volatility on Donations''. Target: \textit{Manufacturing \& Service Operations Management (MSOM)}

\item \textbf{Santanai, A., \underline{Burtch, G.}, Hong, Y., \& Hu, Y.} ``Online Review Censorship''. Target: \textit{Information Systems Research}
...
\item \textbf{Bapna, R. \& \underline{Burtch, G.}} ``To Social-Media or to Hoop? The Impact of the NCAA's Name, Image, and Likeness (NIL) Policy on Students' Athletic Performance''. Target: \textit{Marketing Science} 
