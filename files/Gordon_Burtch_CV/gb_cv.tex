...
\tllabelcventry[gray]{2021}{0}{2021--2024}{Meta Research -- Core Data Science}{Contractor}{New York, NY}{}{}
...
\item \textbf{Babar, Y., \& \underline{Burtch, G.}} (2023) ``Recharging Retail: Estimating Consumer Demand Spillovers from Electric Vehicle Charging Stations'. Forthcoming at \textit{Manufacturing \& Service Operations Management (MSOM)} 
...
\item \textbf{Schanke, S.,  \underline{Burtch, G.} \& Ray, G.} ``Digital Lyrebirds: Experimental Evidence That Voice-based DeepFakes Influence Trust''. Under 2nd Round Review at \textit{Management Science} 
...
\item \textbf{Temple University (Marketing)} \textit{Spring 2024 (TBD)} Philadelphia, PA.
