...
With regular standard errors the "95%" interval covers the truth `r cv("Regular OLS", 50)` of the time. The estimates themselves are unbiased but the 95% CI is too narrow. Clustering fixes most of the problem: coverage rises to `r cv("Clustered CR1, t(n-k)", 50)`.
